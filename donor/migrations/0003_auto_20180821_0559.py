# Generated by Django 2.0.7 on 2018-08-21 05:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='donor.Child')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.AddField(
            model_name='child',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='donor.Project'),
        ),
    ]
